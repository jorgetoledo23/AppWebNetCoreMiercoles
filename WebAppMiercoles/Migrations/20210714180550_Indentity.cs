    ...
    public partial class Indentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblPedidos", x => x.PedidoId);
                    table.ForeignKey(
                        name: "FK_tblPedidos_AspNetUsers_ClienteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tblDetallePedido_tblPedidos_PedidoId",
                        column: x => x.PedidoId,
                        principalTable: "tblPedidos",
                        principalColumn: "PedidoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tblDetallePedido_tblProductos_ProductoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tblDetallePedido_ProductoId",
                table: "tblDetallePedido",
                column: "ProductoId");

            migrationBuilder.CreateIndex(
                name: "IX_tblPedidos_ClienteId",
                table: "tblPedidos",
                column: "ClienteId");
        }
